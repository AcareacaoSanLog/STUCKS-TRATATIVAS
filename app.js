...
const el={};
let filterTimer=null, monitorTimer=null, monitorDaysMenuOpen=false;
...
function setView(view){state.view=view; if(view.startsWith('monitor-')){const nextType=view.replace('monitor-',''); if(state.monitor.type!==nextType){state.monitor={type:nextType,city:'all',bairro:'all',days:'all',sort:'asc',search:''};} else state.monitor.type=nextType;} render();}
